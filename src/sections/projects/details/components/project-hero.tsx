        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center max-w-7xl mx-auto">
          ...
          >
            <div className="space-y-4">
              ...
              >
                <h1 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl text-primary font-bold tracking-tight text-balance">
                  {project.name}
                </h1>
              </motion.div>
              ...
              >
                <div className="max-h-[280px] overflow-y-auto pr-2 pb-4 scrollbar-thin scrollbar-thumb-muted scrollbar-track-transparent">
                  <p className="text-base md:text-lg lg:text-xl text-primary font-semibold leading-relaxed text-pretty">
                    {project.description}
                  </p>
                </div>
